...
TEXT = """3Z 4Z UZ3N37 4Z7 4 C3L7 5Z0LG4LJ4, H0GY B3B1Z0NY1754 M1LY3N C50D4L4705 D0LG0KR4 K3P35 4Z 3LM3.
...
def replace(s,dictionary):
    for keys in dictionary.keys():
        s = s.replace(keys, dictionary[keys])
    return s

def main():
    dictionary = {'3':'E','4':'A','0':'O',
                '7':'T','5':'S','1':'I'}
